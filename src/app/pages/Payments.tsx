...
import { ArrowDownToLine, ArrowUpRight, TrendingUp, Calendar, CreditCard, ArrowLeft, Inbox } from "lucide-react";
          ...
          <Card className="border-gray-100 shadow-sm">
            {visiblePayments.length === 0 ? (
              <div className="p-8 text-center text-gray-400">
                ...
                <p className="text-sm font-medium text-gray-500">Пока нет операций</p>
                <p className="text-xs text-gray-400 mt-1">История появится после первого заказа</p>
              </div>
            ) : (
              <>
